...
class _HomeScreenState extends State<HomeScreen> {
  List<int> reandomNumbers = [123, 456, 789];
  int maxNumber = 1000;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _Body(reandomNumbers: reandomNumbers),
  ...
  void onRandomNumberGenerate() {
    ...
    setState(() {
      reandomNumbers = newNumbers.toList();
    });
  }
...
class _Body extends StatelessWidget {
  final List<int> reandomNumbers;
  const _Body({required this.reandomNumbers, Key? key}) : super(key: key);
